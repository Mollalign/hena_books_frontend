      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-5 leading-tight">
            {language === "am" ? "በእምነት ለማደግ ዝግጁ ነዎት?" : "Are you ready to grow in faith?"}
          </h2>

          <p className="text-base sm:text-lg text-white/80 mb-8 max-w-xl mx-auto leading-relaxed">
            {language === "am" ? "ሕይወትን የሚለውጡ ክርስቲያናዊ መጽሐፍትን ያግኙ ። መንፈሳዊ ጉዞዎ እዚህ ይጀምራል ።" : "Discover life-changing Christian books. Your spiritual journey starts here."}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            >
              ...
              {language === "am" ? "መጽሐፍት ያስሱ" : "Browse Books"}
            </Link>
          </div>
        </div>
      </div>
