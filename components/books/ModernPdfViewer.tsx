...
export default function ModernPdfViewer({
  ...
  // Intercept internal PDF link clicks (TOC, cross-references) for virtualized scrolling
  useEffect(() => {
    ...
    const handleLinkClick = (e: MouseEvent) => {
      ...
      // Internal destination: #page=N or #nameddest=... or react-pdf internal links
      if (href.startsWith("#")) {
        e.preventDefault();
        e.stopPropagation();
        ...
        // react-pdf internal dest links have data-dest-page attribute on a parent or the link itself
