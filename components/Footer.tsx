    ...
    <footer className="bg-navy-950 dark:bg-[#0a0f1a] text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-base font-bold">{language === "am" ? "ብፅዕና መጽሐፍት" : "Hena Books"}</span>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 py-3">
          <p className="flex items-center justify-center gap-1 text-[10px] text-white/30">
            &copy; {new Date().getFullYear()} {language === "am" ? "ብፅዕና መጽሐፍት ።" : "Hena Books."} Made with <Heart className="w-2.5 h-2.5 text-red-400 fill-red-400" /> for the glory of God.
          </p>
        </div>
      </div>
    </footer>
